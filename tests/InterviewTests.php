...
class InterviewTests extends PHPUnit\Framework\TestCase {
    ...
    public function testReverseArray()
    {
        ...
        // Code here
        $data = Vault::stringToReverseArray($data);
    ...
    public function testOrderArray()
    {
        ...
        // Code here
        $data = Vault::orderNumericalArray($data);
    ...
    public function testGetDiffArray()
    {
        ...
        // Code here
        $data = Vault::arrayDiff($data2, $data1);
        $this->assertEquals([8, 9, 10], $data);
        // Code here
        $data = Vault::arrayDiff($data1, $data2);
    ...
    public function testGetDistance()
    {
        ...
        // Code here
        $distance = Vault::getDistance($place1['lat'], $place1['lon'], $place2['lat'], $place2['lon']);
    ...
    public function testGetHumanTimeDiff()
    {
        ...
        // Code here
        $timeDiff = Vault::getHumanTimeDiff($time1, $time2);
