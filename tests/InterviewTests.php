...
class InterviewTests extends PHPUnit\Framework\TestCase {
    ...
    public function testOrderArray()
    {
        ...
        $answer = new Answers();
		$data = $answer->orderStringNumbers($data);
    ...
    public function testGetDiffArray()
    {
        ...
        $answer = new Answers();
		$data = $answer->arrayDifferences($data2, $data1);

        $this->assertEquals([8, 9, 10], $data);

        $data = $answer->arrayDifferences($data1, $data2);
    ...
    public function testGetDistance()
    {
		...
		$answer = new Answers();
		$distance = $answer->calcDistance($place1['lat'], $place1['lon'], $place2['lat'], $place2['lon']);
    ...
    public function testGetHumanTimeDiff()
    {
		...
		$answer = new Answers();
		$timeDiff = $answer->getTimeDiff($time1, $time2);
