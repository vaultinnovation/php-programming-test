<?php
require '../src/Vault/Helper.php';
use Vault\Vault\Helper;
/**
 * Instructions:
 *
...
class InterviewTests extends PHPUnit\Framework\TestCase {
    ...
    public function testReverseArray()
    {
        ...
        $rdata = new Helper();
        $reversed = $rdata->reverse($data);

        $this->assertEquals(['job', 'this', 'want', 'I'], $reversed);
    }
    ...
    public function testGetDiffArray()
    {
        ...
        // Code here
        $helper = new Helper();
        $data = $helper->arrayDiff($data2, $data1);

        $this->assertEquals([8, 9, 10], $data);

        // Code here
        $data = $helper->arrayDiff($data1, $data2);
    ...
    public function testGetDistance()
    {
        ...
        // Code here
        $helper = new Helper();
        $distance = $helper->getDistance($place1, $place2);
    ...
    public function testGetHumanTimeDiff()
    {
        ...
        // Code here
        $helper = new Helper();
        $timeDiff = $helper->getDateDiff($time1,$time2);
