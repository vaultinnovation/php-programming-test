...
class InterviewTests extends PHPUnit\Framework\TestCase {
    ...
    public function testReverseArray()
    {
        ...
        // Code here
        $data = Vault\TestAnswers::stringToReverseArray($data);
    ...
    public function testOrderArray()
    {
        ...
        // Code here
        $data = Vault\TestAnswers::sortStringArrayNumerically($data);
    ...
    public function testGetDiffArray()
    {
        ...
        // Code here
        $data = Vault\TestAnswers::getDiffArray($data2, $data1);

        $this->assertEquals([8, 9, 10], $data);

        // Code here
        $data = Vault\TestAnswers::getDiffArray($data1, $data2);
    ...
    public function testGetHumanTimeDiff()
    {
        ...
        // Code here
        $timeDiff = Vault\TestAnswers::getHumanTimeDiff($time1, $time2);
