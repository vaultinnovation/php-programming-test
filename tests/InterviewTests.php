...
require_once(dirname(__DIR__, 1) . "/src/Vault/InterviewTest.php");

use Vault\InterviewTest;
...
class InterviewTests extends PHPUnit\Framework\TestCase {
    ...
    public function testReverseArray()
    {
        ...
        $interviewTest = new InterviewTest();
        $data = $interviewTest->stringToReverseArray($data);
    ...
    public function testOrderArray()
    {
        ...
        $interviewTest = new InterviewTest();
        $data = $interviewTest->orderArray($data);
    ...
    public function testGetDiffArray()
    {
        ...
        $interviewTest = new InterviewTest();
        $data = $interviewTest->getArrayDiff($data1, $data2);
        
        $this->assertEquals([8, 9, 10], $data);
        
        $data = $interviewTest->getArrayDiff($data2, $data1);
    ...
    public function testGetDistance()
    {
        ...
        $interviewTest = new InterviewTest();
        $distance = $interviewTest->getDistance($place1, $place2);
    ...
    public function testGetHumanTimeDiff()
    {
        ...
        $interviewTest = new InterviewTest();
        $timeDiff = $interviewTest->getHumanTimeDiff($time1, $time2);
