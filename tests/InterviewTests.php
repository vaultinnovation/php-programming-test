...
class InterviewTests extends PHPUnit\Framework\TestCase {
    ...
    public function testReverseArray()
    {
        ...
        // Code here
        (new Interview())->reverseArray($data);
    ...
    public function testGetDiffArray()
    {
        ...
        // Code here
        $data = (new Interview())->getDiffArray($data2, $data1);

        $this->assertEquals([8, 9, 10], $data);

        // Code here
        $data = (new Interview())->getDiffArray($data1, $data2);
    ...
    public function testGetDistance()
    {
        ...
        // Code here
        $distance = (new Interview())->getDistance($place1, $place2);
    ...
    public function testGetHumanTimeDiff()
    {
        ...
        // Code here
        $timeDiff = (new Interview())->getHumanTimeDiff($time1, $time2);
